...

{
  ...
  sleep 0.2
  printf '{"id":42,"jsonrpc":"2.0","method":"Client.SetLatency","params":{"id":"%s","latency":15000}}\n' "$ESP1_ID"
  sleep 0.2
  printf '{"id":43,"jsonrpc":"2.0","method":"Client.SetLatency","params":{"id":"%s","latency":15000}}\n' "$ESP2_ID"
  sleep 0.2
